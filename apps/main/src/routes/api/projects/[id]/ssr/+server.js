  ...
  try {
    ...
    try {
      ...
      for(const lay of [...layouts, match]){
        const c = compile(files[lay], { generate:'ssr', format:'esm', filename: lay, runes: false, compatibility: { componentApi: 4 } });
    ...
    try {
      const w = compile(wrapperSource, { generate:'ssr', format:'esm', filename:'__wrapper_ssr.svelte', runes: false, compatibility: { componentApi: 4 } });
      wrapperJs = w.js.code;
    ...
    try {
      const wDom = compile(wrapperSource, { generate:'dom', format:'esm', filename:'__wrapper_dom.svelte', hydratable:true, runes: false, compatibility: { componentApi: 4 } });
