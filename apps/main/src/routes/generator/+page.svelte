...
<div class="max-w-6xl mx-auto py-8 px-4">
  <div class="mb-6">
    <div class="flex items-center justify-between mb-4">
      <div>
        <h1 class="text-3xl font-bold mb-2 text-indigo-700">Générateur d'application</h1>
        <p class="text-gray-600">Générez des applications SvelteKit complètes avec l'IA</p>
      </div>
